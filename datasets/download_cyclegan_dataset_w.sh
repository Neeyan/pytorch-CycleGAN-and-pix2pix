...
URL=https://drive.google.com/drive/folders/1Qu_cvj8x16nsa1lwaBLVnVKt4Bev-Rcn?usp=sharing

#ZIP_FILE=./datasets/$FILE.zip
ZIP_FILE=./datasets/photo2render.zip

#TARGET_DIR=./datasets/$FILE/
TARGET_DIR=./datasets/photo2render/
